...
// Source: github.com/maxgoover/rezonit-test-task/db/sqlc (interfaces: Storage)
...
func (m *MockStorage) DeleteUser(arg0 context.Context, arg1 int32) error {
	m.ctrl.T.Helper()
...
func (m *MockStorage) GetUser(arg0 context.Context, arg1 int32) (db.User, error) {
	m.ctrl.T.Helper()
